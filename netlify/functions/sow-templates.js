// netlify/functions/sow-templates.js
// Shared SOW template storage via Netlify Blobs
// Architecture mirrors scope-templates.js exactly — separate namespace: 'sow-templates'
...
exports.handler = async function(event, context) {
  ...
  try {
    ...
    console.error('sow-templates error:', err.message, err.stack);
