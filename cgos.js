...
const feedbackToggle2 = document.getElementById('feedback-toggle-2');
if (feedbackToggle2) feedbackToggle2.addEventListener('click', () => feedbackPanel.classList.contains('open') ? closeFeedback() : openFeedback());
